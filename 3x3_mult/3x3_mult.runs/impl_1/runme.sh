...
HD_PWD='/home/lucas/Desktop/fpga/3x3_mult/3x3_mult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi3.tcl -notrace
