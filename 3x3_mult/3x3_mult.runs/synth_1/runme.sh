...
HD_PWD='/home/lucas/Desktop/fpga/3x3_mult/3x3_mult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi3.tcl
